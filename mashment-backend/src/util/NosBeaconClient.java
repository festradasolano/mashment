 ...
 * 
 */
public class NosBeaconClient extends NosClient {
	...
	/**
	 * Constructor of NosBeaconClient
	 */
	public NosBeaconClient() {
		// Create client to access Beacon web resources
	...
	public String getNosDevices(String nosIp, String nosPort)
		...
		webResource = webResource.path("devicemanager").path("devices");
	...
	public String getNosDiscoveredLinks(String nosIp, String nosPort)
		...
		String uri = BASE_URI + nosIp + ":" + nosPort + BASE_REST_URI;
		WebResource webResource = client.resource(uri);
		webResource = webResource.path("topology").path("links");
	...
	public String getNosInformation(String nosIp, String nosPort)
		...
		String uri = BASE_URI + nosIp + ":" + nosPort + BASE_REST_URI;
		WebResource webResource = client.resource(uri);
		webResource = webResource.path("controller").path("info");
	 ...
	 * (non-Javadoc)
	 * 
	 * @see util.NosClient#getNosSwitches(java.lang.String, java.lang.String)
	 */
	...
	public String getNosSwitchFlows(String nosIp, String nosPort, String swId)
		...
		String uri = BASE_URI + nosIp + ":" + nosPort + BASE_REST_URI;
		WebResource webResource = client.resource(uri);
		webResource = webResource.path("switch").path(swId).path("flows");
	...
	public String getNosSwitchPorts(String nosIp, String nosPort, String swId)
		...
		String uri = BASE_URI + nosIp + ":" + nosPort + BASE_REST_URI;
		WebResource webResource = client.resource(uri);
		webResource = webResource.path("switch").path(swId).path("ports");
	...
	public String getNosSwitchPortStatsLogs(String nosIp, String nosPort,
		...
		String uri = BASE_URI + nosIp + ":" + nosPort + BASE_REST_URI;
		WebResource webResource = client.resource(uri);
		webResource = webResource.path("switch").path(swId).path("ffrecord")
				.path("aggports").path(lastLogs);
	...
	public String getNosSwitchTables(String nosIp, String nosPort, String swId)
		...
		String uri = BASE_URI + nosIp + ":" + nosPort + BASE_REST_URI;
		WebResource webResource = client.resource(uri);
		webResource = webResource.path("switch").path(swId).path("tables");
